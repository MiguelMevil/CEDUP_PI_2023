...
$sql = "SELECT username, fone_user FROM usuarios WHERE email_user = ?";
...
if ($stmt) {
    ...
    if ($stmt->num_rows > 0) {
        $stmt->bind_result($nome_usuario, $fone_usuario);
        $stmt->fetch();
    } else {
        $nome_usuario = "Nome não encontrado";
        $fone_usuario = "Telefone não encontrado";
    }
...
<head>
    ...
    <title>Projeto Oasys - Perfil</title>
        ...
        <main>
            ...
            <section class="module content" style="height: 100vh">
                <div class="container" style="margin-top: 80px">
                    <form id="editFields" method="POST" action="atualizarUsuario.php">
                        <div id="perfil">
                            <div id="campos">
                                <h3>Nome:</h3>
                                <input type="text" id="Campo_nome" name="campoNome" value="<?php echo $nome_usuario; ?>" placeholder="Digite seu nome" autocomplete="off">

                                <h3>Telefone:</h3>
                                <input type="text" id="Campo_telefone" name="campoTelefone" value="<?php echo $fone_usuario; ?>" pattern="\([0-9]{2}\) [0-9]{5}-[0-9]{4}" placeholder="Digite seu número de telefone" autocomplete="off">
                    ...
                    <div class="central" style="margin-top: 50px">
                        <a href="consulta_estufa.php">
                            <button class="painel-button">ACESSAR PAINEL DE CONSULTA DA ESTUFA</button>
                        </a>
                    </div>
                </div>
            </section>
