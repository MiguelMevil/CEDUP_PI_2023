...
<head>
    ...
    <title>Projeto Oasys - Login Administrador</title>
        ...
        <main>
            ...
            <section class="module content" style="height: 100vh">
                <div class="container" style="margin-top: 80px">
                    <form id="editFields" method="POST" action="loginAdmin.php">
                        <div id="perfil">
                            <div id="campos">
                                <h3>E-mail:</h3>
                                <input type="text" id="Campo_email" name="campoEmail" placeholder="Digite seu e-mail"
                                    required autocomplete="off" onblur="validacaoEmail(this)">

                                <h3>Senha:</h3>
                                <input type="password" id="Campo_senha1" name="campoSenha"
